...
We have uploaded an example folder in Hugging Face to ease playing around with our models and as a reference for how to format the data. But if you have your own images that you would like to test, you can also use them!
